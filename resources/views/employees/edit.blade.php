        ...
        <div class="row justify-content-center">
            <div class="p-5 bg-light rounded-3 col-xl-4 border">
                ...
                <form action="{{ route('employees.update', ['employee' => $employee->id]) }}" method="POST">
                    ...
                    @method('put')
                    <div class="row">
                        <div class="col-md-6 mb-3"> <label for="firstName" class="form-label">First Name</label>
                            <input class="form-control
                @error('firstName') is-invalid @enderror"
                                type="text" name="firstName" id="firstName"
                                value="{{ $errors->any() ? old('firstName') : $employee->firstname }}"
                                placeholder="Enter First Name"> @error('firstName')
                ...
                is-invalid @enderror"
                        ...
                        <div class="col-md-6 mb-3"> <label for="email" class="form-label">Email</label>
                ...
                is-invalid @enderror" type="text"
                        ...
                        <div class="col-md-6 mb-3"> <label for="age" class="form-label">Age</label>
                ...
                is-invalid @enderror" type="text"
                        ...
                        <div class="col-md-12 mb-3"> <label for="position" class="form-label">Position</label>
